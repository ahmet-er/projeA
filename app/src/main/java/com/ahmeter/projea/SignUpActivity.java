...
import com.ahmeter.projea.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setMessage("Sizin hesabınızı oluşturuyoruz");
                ...
                auth.createUserWithEmailAndPassword
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(SignUpActivity.this,"Kullanıcı başarıyla oluşturuldu",Toast.LENGTH_SHORT).show();
                        }else{
